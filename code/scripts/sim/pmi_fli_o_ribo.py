...
description = ("P-only with LI motor inhibition for rate, F-only LI for intensity "
               " OMR regulation procedure using fit to combined data on bout rate and intensity "
...
indiv_rpt_expt(data, groups=[1, 5, 6, 8, 10, 11, 15], period=(25, 27),
               dep_vars=['optic_flow', 'sensed_flow', 'intensity_scale', 'start_rate', 'start_bout', 'scaled_impulse',
                         'swim_speed', ])

indiv_rpt_expt(data, groups=[1, 5, 6, 8, 10, 11, 15], title='20', period=-20,
               dep_vars=['optic_flow', 'sensed_flow', 'intensity_scale', 'start_rate', 'start_bout', 'scaled_impulse',
                         'swim_speed', ])
...
summary_rpt_expt(data, indep_vars=['height', 'stimulus_speed'],
                 ...
                 period=-20, ncolumns=2, indiv_bout_stats=False,
                 title='last 20 s')
