...
if __name__ == '__main__':
    ...
    description = "single process LI with poisson rate and new profile for intensity, " \
                  "fitting to combined data on bout rate and intensity" \
    ...
    # # 1
    # grid_spec = {'tau': [0.01, 0.056, 0.316, 1.778, 10.0],
    #              'ki_tau_prod_grid': [1.0, 10.0, 100.0, 1000.0, 10000.0],
    #              'kr_tau_prod_grid': [1.0, 10.0, 100.0, 1000.0, 10000.0],
    #              }
    # # 2
    # grid_spec = {'tau': [0.01, 0.056, 0.316, 1.778, 10.0],
    #              'ki_tau_prod_grid': [10.0, 31.623, 100.0, 316.228, 1000.0],
    #              'kr_tau_prod_grid': [10.0, 31.623, 100.0, 316.228, 1000.0],
    #              }
    # # 3
    # grid_spec = {'tau': [0.01, 0.056, 0.316, 1.778, 10.0],
    #              'ki_tau_prod_grid': [10.0, 17.783, 31.623, 56.234, 100.0],
    #              'kr_tau_prod_grid': [31.623, 56.234, 100.0, 177.828, 316.228],
    #              }
    # # 4
    # grid_spec = {'tau': [0.01, 0.056, 0.316, 1.778, 10.0],
    #              'ki_tau_prod_grid': [15.811, 22.361, 31.623, 44.721, 63.246],
    #              'kr_tau_prod_grid': [28.117, 39.763, 56.234, 79.527, 112.468],
    #              }
    # 5
    grid_spec = {'tau': [0.01, 0.018, 0.032, 0.056, 0.1],
                 'ki_tau_prod_grid': [15.811, 22.361, 31.623],
                 'kr_tau_prod_grid': [28.117, 39.763, 56.234],
                 }

    derived_parms = {
        'k_intensity': "ki_tau_prod_grid/tau if tau > 0.01 else ki_tau_prod_grid",
        'k_rate': "kr_tau_prod_grid/tau if tau > 0.01 else kr_tau_prod_grid",
    }
    ...
    contour_fit_figs(costed_features=features,
                     report_vars=['ki_tau_prod_grid:log', 'tau:log'])

    contour_fit_figs(costed_features=features,
                     report_vars=['ki_tau_prod_grid:log', 'kr_tau_prod_grid:log'])

    contour_fit_figs(costed_features=features,
                     report_vars=['kr_tau_prod_grid:log', 'tau:log'])
