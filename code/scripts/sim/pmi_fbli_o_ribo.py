...
description = "P-only with motor integration for rate, split LI for intensity" \
              " omr regulation procedure with fit to combined data on bout rate and intensity"
...
indiv_rpt_expt(data, groups=[1, 5, 6, 8, 10, 11, 15], period=(25, 27),
               dep_vars=['optic_flow', 'sensed_flow', 'intensity_scale', 'start_rate', 'scaled_impulse',
                         'swim_speed', ])
